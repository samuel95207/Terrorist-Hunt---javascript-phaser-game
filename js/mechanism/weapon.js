    ...
    gameStatus.bullets.children.each(function(bullet){
        ...
        if(bullet.trail){
            ...
            if(distance_square < bullet.trail_length**2){
                bullet.line = this.add.line(0,0, bullet.body.firePoint.x, bullet.body.firePoint.y+3, bullet.body.x, bullet.body.y+3, 0xffffff).setOrigin(0, 0);
            }else{
                bullet.line = this.add.line(0,0, bullet.body.x+bullet.trail_length*(bullet.flipX?1:-1), bullet.body.firePoint.y+3, bullet.body.x, bullet.body.y+3, 0xffffff).setOrigin(0, 0);
            }
        }
